                    ...
                    <nav class="navbar navbar-expand-md fixed-top bg-light shadow" data-bs-theme="light">
                        <div class="container-fluid">
                            ...
                            <div class="d-flex justify-content-center">
                                <a class="navbar-brand ml-3 mt-2 d-lg-none" href="/cisnaturatienda/src/sofi/home_admin.php">
                                    <img src="/cisnaturatienda/public/icons/logoCisnatura.png" alt="Logo" height="50">
                                </a>
                                <a class="navbar-brand d-none d-lg-block navbar-logo" href="/cisnaturatienda/src/sofi/home_admin.php">
                            ...
                            <div class="collapse navbar-collapse nav-collapse" id="navbarSupportedContent">
                                <ul class="navbar-nav me-auto mb-0 mb-lg-0 justify-content-center">
                                    <li class="nav-item">
                                        <a class="nav-link mx-1 my-1 button-navbar" href="/cisnaturatienda/src/sofi/home_admin.php">Inicio</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link mx-1 my-1 button-navbar" href="/cisnaturatienda/src/sofi/catalogo_admin.php">Catálogo</a>
                                    </li>
                                </ul>
...
function scripts($script = "")
{
    ?>
        ...
        <?php
        if ($script != '') {
            echo '<script src="/cisnaturatienda/src/sofi/js/' . $script . '.js"></script>';
        }
    }
    function foot()
    {
